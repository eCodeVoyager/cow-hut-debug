...
const getAllSeller = async (pagination: IpaginationOptions, filters: ISellerFilters): Promise<IGenericResponse<ISeller[]>> => {
    const {page, limit} = PaginationHelper.calculatePagination(paginationOptions)
